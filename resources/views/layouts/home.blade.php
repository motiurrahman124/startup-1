                    ...
                    <div class="bg-primary rounded h-100 d-flex align-items-center p-5 wow zoomIn" data-wow-delay="0.9s">
                        <form action="{{ url('appointment_store') }}" method="post">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <input name="email" class="form-control bg-light border-0" placeholder="Your Email"
                                        style="height: 55px;">
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    @else
                                        <a href="{{ route('login') }}" class="btn btn-dark w-100 py-3">Login to Request A
                                            Quote</a>
                                    @endif
                                </div>
                            </div>
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.6s">
                <div class="testimonial-item bg-light my-4">
                    <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        <img class="img-fluid rounded" src="{{ asset('frontend/img/testimonial-1.jpg') }}"
                            style="width: 60px; height: 60px;">
                        <div class="ps-4">
                ...
                <div class="testimonial-item bg-light my-4">
                    <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        <img class="img-fluid rounded" src="{{ asset('frontend/img/testimonial-2.jpg') }}"
                            style="width: 60px; height: 60px;">
                        <div class="ps-4">
                            <h4 class="text-primary mb-1">Client Name</h4>
                            <small class="text-uppercase">Profession</small>
                ...
                <div class="testimonial-item bg-light my-4">
                    <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        <img class="img-fluid rounded" src="{{ asset('frontend/img/testimonial-3.jpg') }}"
                            style="width: 60px; height: 60px;">
                        <div class="ps-4">
                            <h4 class="text-primary mb-1">Client Name</h4>
                            <small class="text-uppercase">Profession</small>
                ...
                <div class="testimonial-item bg-light my-4">
                    <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        <img class="img-fluid rounded" src="{{ asset('frontend/img/testimonial-4.jpg') }}"
                            style="width: 60px; height: 60px;">
                        <div class="ps-4">
                            <h4 class="text-primary mb-1">Client Name</h4>
                            <small class="text-uppercase">Profession</small>
                        ...
                        <div class="blog-item bg-light rounded overflow-hidden">
                            <div class="blog-img position-relative overflow-hidden">
                                <div style="height: 300px">
                                    <img class="img-fluid w-100 h-100" height="200px" src="{{ $data->image }}"
                                        alt="">
                                </div>
                            ...
                            <div class="p-4">
                                <div class="d-flex mb-3 justify-content-between">
                                    <p class="me-3"><i
                                            class="far fa-user text-primary me-2"></i>{{ $data->author_name }}</p>
                                    <p><i
                                            class="far fa-calendar-alt text-primary me-2"></i>{{ Carbon\Carbon::parse($data->created_at)->Format('d M, Y') }}
                                    </p>
                                </div>
